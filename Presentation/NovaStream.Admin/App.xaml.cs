...
public partial class App : System.Windows.Application
{
    ...
    private void Register()
    {
        ...
        Services.AddSingleton<MovieSubtitleViewModel>();
        Services.AddTransient<AddMovieSubtitleViewModel>();
        ...
        Services.AddSingleton<EpisodeSubtitleViewModel>();
        Services.AddTransient<AddEpisodeSubtitleViewModel>();
    ...
    private void Mapster()
    {
        ...
        TypeAdapterConfig<SeasonViewModelContent, Season>.NewConfig()
            .Map(dest => dest.SerialId, src => src.Serial.Id)
        ...
        TypeAdapterConfig<MovieSubtitleViewModelContent, Subtitle>.NewConfig()
            .Map(dest => dest.Movie.Name, src => src.Movie.Name)
            .Ignore(dest => dest.Movie);

        TypeAdapterConfig<Subtitle, MovieSubtitleViewModelContent>.NewConfig()
            .Ignore(dest => dest.Movie);


        TypeAdapterConfig<EpisodeSubtitleViewModelContent, Subtitle>.NewConfig()
            .Map(dest => dest.Episode.Name, src => src.Episode.Name)
            .Ignore(dest => dest.Episode);

        TypeAdapterConfig<Subtitle, EpisodeSubtitleViewModelContent>.NewConfig()
            .Ignore(dest => dest.Episode);
